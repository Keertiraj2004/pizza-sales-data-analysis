# 🍕 Pizza Sales Data Analysis & Interactive Dashboarde
...
| --- | --- |
| `images/dashboard.png` | Full Dashboard — Complete interactive view |
| `images/kpi_cards.png` | KPI Metrics — Key performance indicators |
| `images/sales_trends.png` | Sales Trends — Daily & monthly trends |
...
- Some pizzas generate high order volume but lower revenue
...
- [ ] Integrate SQL database for scalable data storage
